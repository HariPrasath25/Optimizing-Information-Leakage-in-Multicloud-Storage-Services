            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="Cloud_login.jsp" class="smoothScroll">Cloud</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="contact-image">
                            <img src="images/cloud_login.jpg" class="img-responsive" >
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <form id="contact-form" role="form" action="cloud" method="post">
                            <div class="col-md-12 ">
