            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="Download_files.jsp" class="smoothScroll">Download File</a></li>
                    ...
                    <div class="col-md-12">
                        <table id="customers">
                            ...
                            <tr>
                                ...
                                <td><a href="download?fid=<%=rs.getString("id")%>" class="btn btn-lg btn-primary">Download</a></td>
                            </tr>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
