            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a href="Cloud_Home.jsp" class="smoothScroll">Home</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="about-info">
                            <center><h2>Welcome To Cloud Server</h2></center>
                        </div>
                        <div class="contact-image">
                            <br><br><br><br>
                            <img src="images/cloud1.jpg" class="img-responsive" >
                        </div>
                    </div>
                </div>
        </section>
