        ...
        <section id="about">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <form id="contact-form" role="form" action="user_signin.jsp" method="post">
                            <div class="col-md-12 ">
                                <div class="form-group">
                                    <label>Email :</label><br>
                                    <input type="email" placeholder="Enter Your Email" style="width: 300px;" name="email" required=""><br><br>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <a href="user_signup.jsp" class="btn-primary btn-lg">Register!</a>
                            </div>
                        </form>
                    </div>
                </div>
