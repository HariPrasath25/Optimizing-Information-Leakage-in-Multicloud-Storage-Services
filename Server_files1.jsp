            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="Server_files.jsp" class="smoothScroll">Block Files</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="about-info">
                        <center><h2>Block Files</h2></center>
                    </div>
                    <br><br>
                    <div class="col-md-12">
                        <table id="customers">
                            <tr>
                                ...
                                <th>User Name</th>
                                <th>Uploaded Time</th>
                                <th>Min Hash Similarity</th>
                                <th>Verified Min Hash</th>
                                <th>File Block Status</th>
                            </tr>
                            <%
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                                        String hash1 = rs.getString("hash" + block);
                                        String hash2 = rs.getString("mod_hash" + block);
                            ...
                            <tr>
                                ...
                                <td><%=rs.getString("filename")%><%=block%></td>
                                <td><%=rs.getString("uname")%></td>
                                <td><%=rs.getString("time")%></td>
                                <td><%=rs.getString("hash" + block)%></td>
                                <td><%=rs.getString("mod_hash" + block)%></td>
                                <td><%=temp%></td>
                            </tr>
                            <%                                        }
                                } catch (Exception ex) {
